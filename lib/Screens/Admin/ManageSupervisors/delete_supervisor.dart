...
import 'package:dig_app_launcher/Popup/delete_supervisor_popup.dart';
...
class DeleteSupervisorScreen extends StatefulWidget {
  ...
  String elderlyId;
  DeleteSupervisorScreen({Key? key, required this.elderlyId}) : super(key: key);

  @override
  State<DeleteSupervisorScreen> createState() => _DeleteSupervisorScreenState();
}

class _DeleteSupervisorScreenState extends State<DeleteSupervisorScreen> {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Align(
                          ...
                          child: HelpButton(widget: const DeleteSupervisorPopup()),
                        ),
                      )
                    ],
                  ),
