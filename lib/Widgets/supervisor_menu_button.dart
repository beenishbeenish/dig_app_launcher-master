import 'package:dig_app_launcher/Screens/Supervisor/supervisor_account.dart';
...
class SupervisorMenuButton extends StatelessWidget {
  ...
  SupervisorMenuButton({Key? key, required this.onMyAccountPress}) : super(key: key);
                      ...
                      InkWell(
                        onTap: onMyAccountPress? (){
                          ...
                          Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (ctx) => const SupervisorAccountScreen(),
                              )
                          );
                        } : (){},
                        child: Row(
